...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public void populateTree() {
       ...
       // ArrayList<Disease> dList = system.getDiseaseList();
       ...
       // DefaultMutableTreeNode diseases = new DefaultMutableTreeNode("Diseases");
       // root.insert(diseases, 1);

        DefaultMutableTreeNode networkNode;
        DefaultMutableTreeNode enterpriseNode;
        DefaultMutableTreeNode organizationNode;
        //DefaultMutableTreeNode dNode;
        // DefaultMutableTreeNode vaccineNode;
     ...
     /* for (int k = 0; k < dList.size(); k++) {
            disease = dList.get(k);
            dNode = new DefaultMutableTreeNode(disease.getName());
            diseases.insert(dNode, k);
