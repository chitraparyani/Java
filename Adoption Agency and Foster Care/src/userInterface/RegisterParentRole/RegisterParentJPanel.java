...
public class RegisterParentJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, 135, 34));

        jLabel13.setText("Prospectve Parent2 :");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, 135, 39));
        ...
        add(txtParent2, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 120, 193, 34));

        jLabel14.setText("Parent1 age :");
        add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 160, 135, 26));
        ...
        add(txtParent1Age, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 160, 193, 35));

        jLabel15.setText("Email ID : ");
        add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 240, 135, 33));
        add(txtEmailID, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 240, 193, 33));
        ...
        add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 200, 135, 33));
        add(txtParent2Age1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 200, 193, 33));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        int age2 = Integer.parseInt(txtEmailID.getText());
        ...
        parent.setEmailId(txtEmailID.getText());
        }
        ...
        JOptionPane.showMessageDialog(null, "parent created successfully");
        sendEmail("parent2202@gmail.com","Parent@2202",txtEmailID.getText(),"Registration Confirmation Mail", "Parent Registered Successfully");
